...
alias pm='sudo pacman --color auto -S'
alias pmp='sudo pacman -Rns'
alias pms='sudo pacman -Ss'
# paru as aur helper - updates everything
alias pksyua="paru -Syu --noconfirm"
alias upall="paru -Syu --noconfirm"
alias aur="paru -a -S"
alias auru="paru -Syua"
alias aurs="paru -Ss"
...
alias vilightdm="sudo $EDITOR /etc/lightdm/lightdm.conf"
alias vipacman="sudo $EDITOR /etc/pacman.conf"
alias vigrub="sudo $EDITOR /etc/default/grub"
alias viconfgrub="sudo $EDITOR /boot/grub/grub.cfg"
alias vimkinitcpio="sudo $EDITOR /etc/mkinitcpio.conf"
alias vimirrorlist="sudo $EDITOR /etc/pacman.d/mirrorlist"
alias viarcomirrorlist='sudo nano /etc/pacman.d/arcolinux-mirrorlist'
alias visddm="sudo $EDITOR /etc/sddm.conf"
alias visddmk="sudo $EDITOR /etc/sddm.conf.d/kde_settings.conf"
alias vifstab="sudo $EDITOR /etc/fstab"
alias vinsswitch="sudo $EDITOR /etc/nsswitch.conf"
alias visamba="sudo $EDITOR /etc/samba/smb.conf"
alias vignupgconf="sudo nano /etc/pacman.d/gnupg/gpg.conf"
alias vib="$EDITOR ~/.bashrc"
alias viz="$EDITOR ~/.zshrc"
