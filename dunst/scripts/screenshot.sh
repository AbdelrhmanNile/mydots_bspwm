...
send_notification() {
    if >/dev/null 2>&1 command -v notify-send ; then
        if [[ "${store}" == "save" ]] ; then
            ...
            dunstify -h string:fgcolor:#282c34 '      ' -i ~/.config/dunst/icons/screenshot.svg   "<span foreground='#e06c75' font_desc='Cartograph CF Italic 19'><b>Scr</b></span><span foreground='#e5c07b' font_desc='Cartograph CF Italic 19'><b>eens</b></span><span foreground='#98c379' font_desc='Cartograph CF Italic 19'><b>hot</b></span> \n<span foreground='#abb2bf' font_desc='Cartograph CF 13'><b>Screenshot saved!</b></span>"
